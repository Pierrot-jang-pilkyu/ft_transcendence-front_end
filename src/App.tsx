			...
			<BrowserRouter>
				<Routes>
					...
					<>
							...
							<Route path='/Chatting' element={<Chatting socket={socket} id={userId} pageStart="0" name="pjang" avatar="https://cdn.intra.42.fr/users/436a0681d2090c6c2673a67cb9b129e6/pjang.jpg"/>} />
					</>
				)}
				</Routes>
			</BrowserRouter>
